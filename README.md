...
### Or, just use this complete "Safe" Version
I have added extra spacing to this version to guarantee GitHub renders it correctly. You can copy the whole thing.
